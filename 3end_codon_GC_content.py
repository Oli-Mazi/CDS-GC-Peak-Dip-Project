# -*- coding: utf-8 -*-
"""
Created on Sat May 24 15:42:06 2025
...
fileloc="D:/Filtered_Archaea_CDS/Filtered_Thermoproteati_CDS"
...
def Codon_GC_Definer(genome):
    ...
    for gene in genedict.values():
        ...
        for p in range(min(500, len(seq) // 3)):
            GCcount= seq[p*3:((p*3)+3)].count("G")+seq[p*3:((p*3)+3)].count("C")
...
metagenedf.to_csv(f"D:/Archaea_Summative_GC_3end/3end_{group2}_all_GC.csv", index=False)